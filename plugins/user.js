...
//   const messageId = message.msg.contextInfo.stanzaId;

//   try {
//     // Check if myAppStateKey is present
//     const myAppStateKey = 'AAAAAE7m'; // Replace with the actual key if different
//     const state = await message.client.getAppState();
    
//     if (!state[myAppStateKey]) {
//       throw new Error(`myAppStateKey ("${myAppStateKey}") not present`);
//     }

//     // Pin the message
//     await message.client.chatModify({
//       pin: true
//     }, message.jid, [messageId]);

//     await message.reply('Message pinned successfully.');
//   } catch (error) {
//     console.error('Error pinning message:', error);
//     await message.reply('Failed to pin the message. Please try again later.');
//   }
// });
