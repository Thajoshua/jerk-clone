...
class Message extends Base {
    ...
    async downloadMediaMessage() {
        try {
            ...
            } else if (this.quoted && (this.quotedType === 'imageMessage' || this.quotedType === 'videoMessage')) {
                messageToDownload = this.quoted;
            } else {
    ...
    async reply(text, options = {}) {
        ...
        const message = await this.client.sendMessage(this.jid, { text: footerText }, { quoted: this.data, ...options });
    ...
    async sendMessage(jid, text, options = {}) {
        const message = await this.client.sendMessage(jid, { text }, options);
        return new Message(this.client, message);
    }
